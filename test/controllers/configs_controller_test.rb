...
class ConfigsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create config" do
    assert_difference('Config.count') do
      post configs_url, params: { config: { app_commission: @config.app_commission, app_title: @config.app_title, sme_commission: @config.sme_commission } }
    end
  ...
  test "should update config" do
    patch config_url(@config), params: { config: { app_commission: @config.app_commission, app_title: @config.app_title, sme_commission: @config.sme_commission } }
